...
<head>
  ...
  <title>Tehama Marathon - terms</title>
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Tehama Half Marathon Terms And Conditions</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>TEHAMA Half Marathon Terms and Conditions</h3>
            <p style="text-align:justify">
              <ol>
                <li>I acknowledge that I have read and understood the Terms and Conditions below.</li>
                <li>I acknowledge that by submitting an application form to enter and participate in the TEHAMA Half Marathon, I am aware of the potential risks including an accident, dehydration, or even death. I voluntarily agree to the causes of all these risks and consent to receive treatment for the risk of an accident or emergency.</li>
                <li>I will abide by the rules and schedules of the TEHAMA Half Marathon, and I will comply with the instructions given by the race administrators and recognize that they have the right to accept or reject a request outside the race schedule or procedures.</li>
                <li>I agree that the entry fee that I paid myself or anyone else entitles me to participate during the TEHAMA Half Marathon, and is a contribution to the community, so in any case, I will not ask for a refund.</li>
              </ol>
            </p>
          </div>
        </div>
